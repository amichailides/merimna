...
public final class ValidationPatterns {
    ...
    public static final String GREEK_LATIN_EXTENDED = "^[A-Za-zΑ-Ωα-ωΆ-ώ0-9\\s\\-._,()!\\:/&]+$";

    // Postal code: supports common international formats with letters, digits, spaces and hyphens.
    public static final String POSTAL_CODE = "^[A-Za-z0-9\\s-]{3,10}$";
