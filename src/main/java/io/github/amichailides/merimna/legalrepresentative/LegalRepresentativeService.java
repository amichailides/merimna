...
public interface LegalRepresentativeService {
    ...
    void assignToBeneficiary(String beneficiaryPublicId, Long legalRepresentativeId);

    void unassignLegalRepresentative(String beneficiaryPublicId, Long legalRepresentativeId);
